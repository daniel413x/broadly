...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. Anastasia's Store)
   */
  name: string;
  /**
   * This is the subdomain for the store (e.g. [slug].broadly.com)
   */
  slug: string;
...
export interface Product {
  ...
  content?: string | null;
  /**
   * If checked, this product will be archived and will not show up in the store
   */
